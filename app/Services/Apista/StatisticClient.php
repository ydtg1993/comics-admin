...
class StatisticClient
{
    ...
    {
        $report_address = $report_address ? $report_address : 'udp://192.168.1.220:55656';
...
{
    StatisticClient::tick("TestModule", 'NOW_ERR');
    usleep(rand(10000, 600000));
    $success = rand(0,1);
    $code = rand(300, 400);
    $msg = '这个是测试消息';
    var_export(StatisticClient::report('TestModule', 'NOW_ERR', $success, $code, $msg));;
}
